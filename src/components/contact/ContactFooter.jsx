  ...
  return (
    <section id="contact">
      <footer className="bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 text-white py-12 px-4 md:px-16">
        <div className={`max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 transition-opacity duration-1000 ${animate ? 'animate-on-load' : ''}`}>
          ...
          <div>
            ...
            <div className="flex flex-wrap space-x-4 sm:space-x-5 text-xl sm:text-2xl">
          ...
          <form
            ref={form}
            onSubmit={sendEmail}
            className="w-full max-w-md bg-white bg-opacity-10 backdrop-blur-sm p-4 sm:p-6 rounded-lg shadow-lg space-y-4"
          >
            <h3 className="text-xl sm:text-2xl font-semibold mb-2 text-gray-300">Send a Message</h3>
            <input
              type="text"
              name="user_name"
